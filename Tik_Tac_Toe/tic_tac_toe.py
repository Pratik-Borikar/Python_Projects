...
status_label = tk.Label(root, text="X's turn", font=('Ariel', 15), bg='#00008B', fg='snow')
...
play_area = tk.Frame(root, width=700, height=700, bg='white')
XO_points = []
X_points = []
O_points = []
...
class XOPoint:
    def __init__(self, x, y):
        ...
        self.y = y
        self.value = None
        self.button = tk.Button(play_area, text="", width=10, height=5, command=self.set, font=('Ariel', 20, 'bold'))
